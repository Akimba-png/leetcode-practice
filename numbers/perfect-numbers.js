...
// На первом шаге ислючаем единицу (т.к. она не подходит по условию
// не включать само число) При этом единицу сразу добавляем к ответу,
// т.к. все числа делятся без остатка на 1.
// Итерацию начинаем с 2 т.к единицу уже добавили.
